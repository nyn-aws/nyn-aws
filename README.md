...
**Automation Test Engineer | 4 Years Experience**

---

I specialize in web application UI and API testing, covering a wide range of scenarios to implement complete application workflows. My expertise lies in designing scalable and maintainable test suites that can be easily extended to cover new requirements and complex use cases.

This profile showcases automation of demo websites using Playwright with TypeScript, and leverages GitHub Actions for seamless CI/CD execution of tests.
